...
class uNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.Conv0 = self._transition(1, 8) #1918
        ...
        self.up4=self._up_block(32,16,16,output_padding=(1,1)) # 959
        ...
        self.conv6 = nn.Conv2d(8, num_classes, 1)
        self.clss = nn.Softmax2d()
    ...
    def forward(self, x):
       ...
       # print('self.up1(down5)',self.up1(down5).size())
        ...
        del down2
        #print(self.db4(self.up4(up3)).size(),down1.size())
